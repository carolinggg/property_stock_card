...
class StockController extends Controller
{
    ...
    ->get()
    ->sortBy(fn($stock) => $stock->item->item_name)
    ->values(); // Reset keys
...
public function create()
{
    ...
    return view('stocks.create', compact('items', 'units'));  // Render the 'add' view for adding new stock
}
...
$validated = $request->validate([
    ...
    public function update(Request $request, $id)
    {
        ...
        $stock->ris_number = $validated['ris_number'];
